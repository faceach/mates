...
namespace Microsoft.ProjectOxford.Facial
{
    ...
    public interface IFaceServiceClient
    {
        ...
        Task<Facial[]> DetectAsync(string url, bool analyzesFacialLandmarks = false, bool analyzesAge = false, bool analyzesGender = false, bool analyzesHeadPose = false);
        ...
        /// <returns>The detected faces.</returns>
        Task<Facial[]> DetectAsync(Stream imageStream, bool analyzesFacialLandmarks = false, bool analyzesAge = false, bool analyzesGender = false, bool analyzesHeadPose = false, bool retainImage = false);
